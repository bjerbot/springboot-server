...
fetch(getOrderUrl, {
    ...
    .then(data => {
        ...
        for(let i = 0; i < orderCount; i++){
            ...
            orderId.style.width = "50%";
            createdDate.style.width = "20%";
            totalAmount.style.width = "30%";
        ...
        orderList.forEach((order, orderIndex) => {
            ...
            order.addEventListener("click", e => {
                ...
                if(!isOrderOpen) {
                    ...
                    newTableContainer.id = "new_table_container_" + orderIndex;
                    ...
                    console.log("isOrderOpen:" + isOrderOpen);
                    isOrderOpen = true;
                }
                //當訂單細項是打開時
                else if(isOrderOpen){
                    let newTableContainer = document.getElementById("new_table_container_" + orderIndex);
                    console.log(newTableContainer);
                    newTableContainer.remove();
